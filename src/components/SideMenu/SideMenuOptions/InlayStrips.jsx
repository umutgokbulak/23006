...
import inlayStrips from '../../../data/InlayStrips.json';
import '../SideMenuOptions/SideMenuOptions.css';

const InlayStrips = memo(function InlayStrips({
  onSelect,
  windowWidth,
  mouseEntered,
  setUrl,
  ...
  return (
    ...
    >
      ...
      >
        {inlayStrips.styles.map((style, styleIndex) => (
                  ...
                  <li
                    ...
                    onClick={() => {
                      ...
                      setUrl(
                        {
                          inlayId: item.id,
                          inlayImg: item.imagePath,
                          inlayName: item.imageName,
                          inlayStyle: item.style,
                        },
                        'replaceIn'
                      );
                    }}
